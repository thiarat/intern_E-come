...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // 2. Create Categories
        const catElectronics = yield prisma.category.create({ data: { name: 'Electronics' } });
        const catAudio = yield prisma.category.create({ data: { name: 'Audio & Sound' } });
        const catWearables = yield prisma.category.create({ data: { name: 'Wearables' } });
        const catHome = yield prisma.category.create({ data: { name: 'Smart Home' } });
